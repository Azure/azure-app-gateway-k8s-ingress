# Based on the acs-engine development container image - TODO: some of this may
# not be required for the ingress controller
...
WORKDIR /gopath/src/github.com/Azure/azure-app-gateway-k8s-ingress

# TODO: figure out what acs-engine was doing here and do the equivalent!
# Cache vendor layer
# ADD Makefile test.mk versioning.mk glide.yaml glide.lock /gopath/src/github.com/Azure/azure-app-gateway-k8s-ingress/
# RUN make bootstrap
...
ADD . /gopath/src/github.com/Azure/azure-app-gateway-k8s-ingress
